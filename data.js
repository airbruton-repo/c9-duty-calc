...
const INFO_CONTENT = {
    'dhd': { title: 'Deadhead (DHD)', text: 'Select if your final segment is a <b>Deadhead</b>. Deadheads have a <b>0-minute debrief time</b>.' },
    'custEnd': { title: 'Customs at End', text: 'Select if you must clear <b>customs</b> after your final segment. Adds <b>15 minutes</b> to your duty day.' },
    'hvt': { title: 'High Value Trip (HVT)', text: 'Answer "<b>Yes</b>" to High Value Trip (HVT) if <b>ALL</b> are true:<br><br>• Single duty period pairing<br>• Originally scheduled no more than <b>3 segments</b><br>• Originally scheduled at <b>9 or more hours</b> flight time<br>• Originally scheduled <b>OVER 13 hours</b> duty time' },
    'mixed': { title: 'Definitions & Mixed Pairings', text: '<b>Mixed Pairings (Sec 6.U):</b><br>• Use <b>DOMESTIC</b> mode if your duty period today contains <b>ONLY</b> domestic flights.<br>• Use <b>INTERNATIONAL</b> mode if your duty period today contains <b>ANY</b> international flights.<br><br><b>Domestic Definition (Sec 2.G):</b><br>• All Company certified routes or charter operations within the <b>50 United States</b>, <b>Puerto Rico</b>, <b>Canada</b>, <b>Mexico</b>, <b>Central America</b>, and the <b>Caribbean</b>.<br><br><b>International Definition (Sec 2.S):</b><br>• All Company certified routes or charter operations to and from the continents of <b>South America</b>, <b>Europe</b>, <b>Asia</b>, <b>Africa</b>, <b>Australia</b>, and <b>Antarctica</b>.<br>• International Flying includes flying to and from <b>Guam</b> and any other island countries and territories <b>outside the Caribbean</b>.' },
    'coterm': { title: 'Co-Terminal Extension', text: 'Answer <b>YES</b> only if this is the <b>final duty period</b> of your pairing <b>AND</b> it terminates at a <b>different co-terminal</b> than your pairing began.<br><br>(Example: Pairing started at <b>EWR</b> but ends at <b>LGA</b>).' },
    'report': { title: 'Report for Duty Info', text: '• Enter the <b>airport code</b> of the city you reported to at the start of the duty day. If the timezone does not populate, check your airport code or you can adjust it manually.<br>• Next, in the <b>Local Report Time</b> field, enter your local report time from your pairing OR the time you actually reported (if different).<br>• Then proceed to the Departure Flight Info section.' },
    'departure': { title: 'Door Close Flight Info', text: '• Enter the <b>airport code</b> of the departure city of your door close segment.<br>• Enter the <b>scheduled flight time</b> for this segment as HHMM.' },
    'firstTime': { title: 'Quick Start Guide', text: '1. Select your <b>Mode</b> (Domestic/International).<br>2. Enter your <b>Duty Date</b> and <b>Pairing Origination</b>.<br>3. Enter your <b>Report City</b> and <b>Time</b>. The calculator will auto-detect time zones (or ask you if it\'s unsure).<br>4. Enter your <b>Door Close City</b> and <b>Scheduled Flight Time</b>.<br>5. Answer the modifier questions.<br>6. Click <b>Calculate</b> to see your legal Door Closure time.' },
    'domMatrix': { title: 'Domestic Actual Max Duty Limits', text: '<b>Report Time (Home Domicile Time)</b><br><br><b>0500 - 1859</b> .... 15:00<br><b>1900 - 0459</b> .... 13:00<br><b>High Value Trip</b> .... 16:00<br><br>(Source: JCBA Section 6.S.1)' },
    'intMatrix': { title: 'International Actual Max Duty Limits', text: '<b>Flight Time (Scheduled)</b><br><br>Multi/Non-Stop <b>≤ 8:00</b> .... 16:00<br>Multi/Non-Stop <b>8:01 - 12:00</b> .... 16:30<br>Non-Stop <b>> 12:00</b> .... Check-in + Flight + Customs + Debrief + 3:30<br><br>(Source: JCBA Section 6.T.1)' },
    'domFlying': { title: 'Domestic Flying', text: '"<b>Domestic Flying</b>" or "<b>Domestic Flight</b>", for scheduling purposes, means all Company certified routes or charter operations within the <b>50 United States</b>, <b>Puerto Rico</b>, <b>Canada</b>, <b>Mexico</b>, <b>Central America</b>, and the <b>Caribbean</b>.' },
    'intFlying': { title: 'International Flying', text: '"<b>International Flying</b>" or "<b>International Flight</b>", for scheduling purposes, means all Company certified routes or charter operations to and from the continents of <b>South America</b>, <b>Europe</b>, <b>Asia</b>, <b>Africa</b>, <b>Australia</b>, and <b>Antarctica</b>. International Flying includes flying to and from <b>Guam</b> and any other island countries and territories <b>outside the Caribbean</b>.' },
    'multiSegment': { title: 'Multi-Segment Duty Period', text: 'Select <b>Multi</b> if your international duty period has <b>multiple flight segments</b>.<br><br>The calculator needs to know the <b>TOTAL scheduled flight time</b> of all segments to determine the correct max duty limit (<b>16:00</b> vs <b>16:30</b>).' }
};
