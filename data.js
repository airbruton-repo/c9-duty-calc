...
const INFO_CONTENT = {
    ...
    'hvt': { title: 'High Value Trip (JCBA Sec 6.S.1)', text: 'A <b>High Value Trip (HVT)</b> shall be limited to a single duty period containing:<br>• No more than <b>three (3) flight segments</b><br>• Total flight time of <b>nine hours (9:00) or more</b>' },
    ...
    'coterm': { title: 'Co-Terminal Extension', text: 'Check this box <b>ONLY</b> if this is the <b>final duty period</b> of your pairing <b>AND</b> it terminates at a <b>different co-terminal</b> than your pairing began.<br><br>(Example: Pairing started at <b>EWR</b> but ends at <b>LGA</b>).' },
