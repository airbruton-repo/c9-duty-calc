...
const INFO_CONTENT = {
    ...
    'multiSegment': { title: 'Multi-Segment Duty Period', text: 'Check this if your international duty period has multiple flight segments.\n\nThe calculator needs to know the TOTAL scheduled flight time of all segments to determine the correct max duty limit (16:00 vs 16:30).\n\nEnter each segment\'s flight time, then select which segment you are calculating door close for.' }
};
