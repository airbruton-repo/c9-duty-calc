...
const INFO_CONTENT = {
    ...
    'mixed': { title: 'Definitions & Mixed Pairings', text: '<b>Mixed Pairings (Sec 6.U):</b><br>• Use <b>DOMESTIC</b> mode if your duty period today contains <b>ONLY</b> domestic flights.<br>• Use <b>INTERNATIONAL</b> mode if your duty period today contains <b>ANY</b> international flights.<br><br><b>Domestic Definition (Sec 2.G):</b><br>• All Company certified routes or charter operations within the <b>50 United States, Puerto Rico, Canada, Mexico, Central America</b>, and the <b>Caribbean</b>.<br><br><b>International Definition (Sec 2.S):</b><br>• All Company certified routes or charter operations to and from the continents of <b>South America, Europe, Asia, Africa, Australia</b>, and <b>Antarctica</b>.<br>• International Flying includes flying to and from <b>Guam</b> and any other island countries and territories <b>outside the Caribbean</b>.' },
    ...
    'timedOut': {
        title: 'What if it is past FA Door close (timed out)?',
        text: '<ul class="list-disc pl-4 space-y-2"><li>One minute after FA Door Closure time, you are not legal to work that flight.</li><li>If on board with passengers and the boarding door is still open, put in the EZ Chat that "Flight Attendant/s (include names) have timed out for max duty and are no longer legal to operate this flight"</li><li>Advise flight deck and CSR that you have timed out</li><li>Attempt to contact Crew Scheduling via phone or chat</li><li>You may be required to stay with pax until your replacements arrive</li><li>Do not "walk off" the aircraft or violate FAA minimums if passengers onboard</li><li>While you are not legal to work this flight, you are still legal to be on duty until you reach your actual max and may still be legal to operate another, shorter flight, and/or remain onboard with passengers until the replacement crew arrives.</li></ul>'
    }
};
